...
export default function DeliveredPage() {
  ...
  async function refresh() {
    try {
      setLoading(true);
      const data = await getLoadsByStatus("DELIVERED");
      setRows(data);
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div className="p-4">
      <div className="mb-4 flex items-center justify-between">
        <h2 className="text-lg font-semibold">Delivered Loads</h2>
      ...
      {loading ? (
        ...
        <div className="text-neutral-400 text-sm">No delivered loads found</div>
      ) : (

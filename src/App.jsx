...
import DriversPage from "./pages/drivers.jsx"; // 👈 make sure this import exists & matches file casing
        ...
        <div className="flex-1 min-w-0">
          ...
          <main className="p-6">
            <Routes>
              ...
              <Route path="/drivers" element={<DriversPage />} /> {/* 👈 this is the key */}
              {/* add your other routes (in-transit, delivered, etc.) */}
            </Routes>
          </main>
        </div>
      </div>
